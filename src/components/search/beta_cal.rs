...
pub fn EnterDateBar() -> impl IntoView {
    ...
    view! {
         <div class="space-y-2">
            <div class="rounded-xl py-2 dark:mix-blend-screen dark:hover:bg-blend-lighten">
                <section class="relative py-2 dark:hover:bg-blend-lighten dark:mix-blend-screen w-full text-start -skew-y-3 scale-75 hover:-translate-y-2 hover:scale-100 focus:-translate-y-2 focus:scale-100 ease-in-out duration-300 glitch">
                    <input on:keydown=only_num node_ref=year_input_el on:change=update_year
                            placeholder="Year" type="text" class="p-2 italic w-full dark:bg-slate-900 bg-slate-200 desktop:text-2xl laptop:text-2xl tablet:text-2xl text-xl"
                            maxlength="4" name="year" value=year
                            oninput="this.form.requestSubmit()"
                    />
                    <button class="absolute inset-y-0 z-20 end-0 cursor-grab hover:text-red-400 dark:text-white text-black dark:hover:text-red-800 p-2 dark:hover:bg-blend-lighten dark:mix-blend-screen text-start" 
                ...
                <section class="relative py-2 dark:hover:bg-blend-lighten dark:mix-blend-screen w-full text-start -skew-y-3 scale-75 hover:-translate-y-2 hover:scale-100 focus:-translate-y-2 focus:scale-100 ease-in-out duration-300 glitch ">
                    <input on:keydown=only_num node_ref=month_input_el on:change=update_month
                            placeholder="Month" type="text" class="p-2 italic w-full dark:bg-slate-900 bg-slate-200 desktop:text-2xl laptop:text-2xl tablet:text-2xl text-xl"
                            maxlength="2" name="month" value=month
                            oninput="this.form.requestSubmit()"
                    />
                    <button class="absolute inset-y-0 z-20 end-0 cursor-grab hover:text-red-400 dark:text-white dark:hover:text-red-800 text-black p-2 dark:hover:bg-blend-lighten dark:mix-blend-screen text-start " 
                ...
                <section class="relative py-2 dark:hover:bg-blend-lighten dark:mix-blend-screen w-full text-start -skew-y-3 scale-75 hover:-translate-y-2 hover:scale-100 focus:-translate-y-2 focus:scale-100  ease-in-out duration-300 glitch ">
                    <input on:keydown=only_num node_ref=day_input_el on:change=update_day
                            placeholder="Day" type="text" class="p-2 italic w-full dark:bg-slate-900 bg-slate-200 desktop:text-2xl laptop:text-2xl tablet:text-2xl text-xl"
                            maxlength="2" name="day" value=day
                            oninput="this.form.requestSubmit()"
                    />

                    <button class="absolute inset-y-0 z-20 end-0 cursor-grab hover:text-red-400 dark:text-white text-black dark:hover:text-red-800
                        p-2 dark:hover:bg-blend-lighten dark:mix-blend-screen text-start
